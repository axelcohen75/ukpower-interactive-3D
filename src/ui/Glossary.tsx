...
const GLOSSARY: [string, string][] = [
  ...
  ["NESO", "National Energy System Operator — balances supply and demand in real time nationally, like air traffic control for electricity. Owns no physical wires."],
